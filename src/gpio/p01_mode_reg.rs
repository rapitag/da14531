#[doc = "Register `P01_MODE_REG` reader"]
pub struct R(crate::R<P01_MODE_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P01_MODE_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P01_MODE_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P01_MODE_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P01_MODE_REG` writer"]
pub struct W(crate::W<P01_MODE_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P01_MODE_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P01_MODE_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P01_MODE_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "P01 Mode Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p01_mode_reg](index.html) module"]
pub struct P01_MODE_REG_SPEC;
impl crate::RegisterSpec for P01_MODE_REG_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [p01_mode_reg::R](R) reader structure"]
impl crate::Readable for P01_MODE_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p01_mode_reg::W](W) writer structure"]
impl crate::Writable for P01_MODE_REG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets P01_MODE_REG to value 0x0200"]
impl crate::Resettable for P01_MODE_REG_SPEC {
    #[inline(always)]
