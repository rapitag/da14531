#[doc = "Register `UART_SFE_REG` reader"]
pub struct R(crate::R<UART_SFE_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UART_SFE_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UART_SFE_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UART_SFE_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UART_SFE_REG` writer"]
pub struct W(crate::W<UART_SFE_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UART_SFE_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UART_SFE_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UART_SFE_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Shadow FIFO Enable\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uart_sfe_reg](index.html) module"]
pub struct UART_SFE_REG_SPEC;
impl crate::RegisterSpec for UART_SFE_REG_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [uart_sfe_reg::R](R) reader structure"]
impl crate::Readable for UART_SFE_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uart_sfe_reg::W](W) writer structure"]
impl crate::Writable for UART_SFE_REG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UART_SFE_REG to value 0"]
impl crate::Resettable for UART_SFE_REG_SPEC {
    #[inline(always)]
