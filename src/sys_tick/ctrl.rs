...
#[doc = "Field `COUNTFLAG` reader - Timer counted to 0 since last time this was read"]
...
#[doc = "Field `COUNTFLAG` writer - Timer counted to 0 since last time this was read"]
...
impl R {
    ...
    #[doc = "Bit 16 - Timer counted to 0 since last time this was read"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CTRL to value 0x04"]
