#[doc = "Register `PATCH_ADDR4_REG` reader"]
pub struct R(crate::R<PATCH_ADDR4_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PATCH_ADDR4_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PATCH_ADDR4_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PATCH_ADDR4_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PATCH_ADDR4_REG` writer"]
pub struct W(crate::W<PATCH_ADDR4_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PATCH_ADDR4_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PATCH_ADDR4_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PATCH_ADDR4_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct PATCH_ADDR4_REG_SPEC;
impl crate::RegisterSpec for PATCH_ADDR4_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [patch_addr4_reg::R](R) reader structure"]
impl crate::Readable for PATCH_ADDR4_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [patch_addr4_reg::W](W) writer structure"]
impl crate::Writable for PATCH_ADDR4_REG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PATCH_ADDR4_REG to value 0x07f0_0000"]
impl crate::Resettable for PATCH_ADDR4_REG_SPEC {
    #[inline(always)]
