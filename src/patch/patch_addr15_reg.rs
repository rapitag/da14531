#[doc = "Register `PATCH_ADDR15_REG` reader"]
pub struct R(crate::R<PATCH_ADDR15_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PATCH_ADDR15_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PATCH_ADDR15_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PATCH_ADDR15_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PATCH_ADDR15_REG` writer"]
pub struct W(crate::W<PATCH_ADDR15_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PATCH_ADDR15_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PATCH_ADDR15_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PATCH_ADDR15_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [patch_addr15_reg](index.html) module"]
pub struct PATCH_ADDR15_REG_SPEC;
impl crate::RegisterSpec for PATCH_ADDR15_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [patch_addr15_reg::R](R) reader structure"]
impl crate::Readable for PATCH_ADDR15_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [patch_addr15_reg::W](W) writer structure"]
impl crate::Writable for PATCH_ADDR15_REG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PATCH_ADDR15_REG to value 0x07f0_0000"]
impl crate::Resettable for PATCH_ADDR15_REG_SPEC {
    #[inline(always)]
